...
class Scheduler:
    ...
    def add_noise(self, x_t, t, noise):
        ...
        sqrt_one_minus_alpha_cumprod = self.sqrt_one_minus_alpha_cumprod.to(x_t.device)[t].reshape(batch_size)
        ...
        return sqrt_alpha_cumprod.to(x_t.device) * x_t + sqrt_one_minus_alpha_cumprod.to(x_t.device) * noise
